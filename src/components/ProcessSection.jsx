...
const steps = [
  {
    n: "01",
    title: "On échange",
    text: "Un premier appel gratuit et sans engagement. Tu me racontes ton projet, tes objectifs et ton budget — je te dis franchement ce qui est réaliste.",
  },
  {
    n: "02",
    title: "Devis & maquette",
    text: "Tu reçois un devis détaillé et une maquette de ton futur site. Rien ne démarre avant ton feu vert, et le prix annoncé est le prix final.",
  },
  {
    n: "03",
    title: "Développement",
    text: "Je code ton site sur mesure, sans template. Tu suis l'avancement sur un lien de préversion et tu peux demander des ajustements à chaque étape.",
  },
  {
    n: "04",
    title: "Mise en ligne & suivi",
    text: "Je m'occupe du nom de domaine, de l'hébergement et du référencement. Une fois en ligne, je reste disponible pour te faire évoluer.",
  },
];
  ...
  return (
    ...
    >
      ...
      <p className="mt-4 mb-10 md:mb-14 max-w-[680px] text-center text-base md:text-[1.2rem] leading-[27px] text-black">
        Quatre étapes claires, aucune mauvaise surprise. Tu sais à tout moment
